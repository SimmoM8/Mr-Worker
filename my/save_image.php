...
$img_scale = filter_input( INPUT_POST, 'img_scale', FILTER_VALIDATE_FLOAT );
$img_pos_x = filter_input( INPUT_POST, 'img_pos_x', FILTER_VALIDATE_FLOAT );
$img_pos_y = filter_input( INPUT_POST, 'img_pos_y', FILTER_VALIDATE_FLOAT );
