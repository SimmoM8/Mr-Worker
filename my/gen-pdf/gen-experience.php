...
foreach ($employers as $employer) {
  ...
  genExp($pdf, $content['x'] + $content['margin'][3], $currentY, $content['inner_width'], $employer["job_position_$selected_language"], $employer['employer'], $employer['area'] . ", " . $employer["country_$selected_language"], $employer['start_date'], $employer['end_date'], $style);
