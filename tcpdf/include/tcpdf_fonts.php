	...
	public static function addTTFfont($fontfile, $fonttype='', $enc='', $flags=32, $outpath='', $platid=3, $encid=1, $addcbbox=false, $link=false) {
		...
		if (empty($fonttype)) {
			if (TCPDF_STATIC::_getULONG($font, 0) == 0x10000) {
				...
				echo "ERROR (line 110): TCPDF does not support this font type. Please make sure to use a ttf (TrueType font).";
				return false;
			} else {
				// Type 1
				$fonttype = 'Type1';
		...
		if ($fmetric['type'] == 'Type1') {
			...
			if (TCPDF_STATIC::_getULONG($font, $offset) != 0x10000) {
				...
				echo "ERROR (line 366): Invalid file type version of TrueType ";
				return false;
			}
